...
@dataclass(frozen=True)
class CodexConfig:
    """Runtime configuration for the Python Codex core."""
    ...
    def resolved_auto_compact_token_limit(self) -> int | None:
        ...
        config_limit = self.model_auto_compact_token_limit
...
@dataclass(frozen=True)
class CodexEvent:
    """JSONL-friendly event emitted by the Python Codex core."""
...
def _default_remote_compaction_mode() -> RemoteCompactionMode:
    value = os.environ.get("PY_CODEX_REMOTE_COMPACTION", "auto").lower()
